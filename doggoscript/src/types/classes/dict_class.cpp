...
Instance* DictClass::new_instance(
    std::vector<std::tuple<Object*, Object*>> initial_value) {
...
DictClass::DictClass(std::vector<std::tuple<Object*, Object*>> initial_value) :
    BuiltInClass("Dict") {
    ...
    this->symbol_table->set(
        "set",
        new BuiltInFunction("set", { "key", "value" },
                            [this](std::vector<Object*> args) -> RuntimeResult {
                                RuntimeResult result;
