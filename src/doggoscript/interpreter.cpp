...
RuntimeResult Interpreter::visit(BaseNode *node, Context& context) {
    switch(node->type) {
        case NodeType::NumberNode: return this->visit_NumberNode(static_cast<NumberNode*>(node), context);
        case NodeType::BinaryOperationNode: return this->visit_BinaryOperationNode(static_cast<BinaryOperationNode*>(node), context);
        case NodeType::UnaryOperationNode: return this->visit_UnaryOperationNode(static_cast<UnaryOperationNode*>(node), context);
        case NodeType::StatementsNode: return this->visit_StatementsNode(static_cast<StatementsNode*>(node), context);
        case NodeType::BooleanNode: return this->visit_BooleanNode(static_cast<BooleanNode*>(node), context);
        case NodeType::VariableAssignmentNode: return this->visit_VariableAssignmentNode(static_cast<VariableAssignmentNode*>(node), context);
        case NodeType::VariableAccessNode: return this->visit_VariableAccessNode(static_cast<VariableAccessNode*>(node), context);
        case NodeType::VariableReassignmentNode: return this->visit_VariableReassignmentNode(static_cast<VariableReassignmentNode*>(node), context);
        case NodeType::StringNode: return this->visit_StringNode(static_cast<StringNode*>(node), context);
        case NodeType::ListNode: return this->visit_ListNode(static_cast<ListNode*>(node), context);
        case NodeType::FunctionDefinitionNode: return this->visit_FunctionDefinitionNode(static_cast<FunctionDefinitionNode*>(node), context);
        case NodeType::IdentifierNode: return this->visit_IdentifierNode(static_cast<IdentifierNode*>(node), context);
        case NodeType::CallNode: return this->visit_CallNode(static_cast<CallNode*>(node), context);
        case NodeType::ReturnNode: return this->visit_ReturnNode(static_cast<ReturnNode*>(node), context);
        case NodeType::ContinueNode: return this->visit_ContinueNode(static_cast<ContinueNode*>(node), context);
        case NodeType::BreakNode: return this->visit_BreakNode(static_cast<BreakNode*>(node), context);
        case NodeType::IfNode: return this->visit_IfNode(static_cast<IfNode*>(node), context);
        case NodeType::ForNode: return this->visit_ForNode(static_cast<ForNode*>(node), context);
        case NodeType::WhileNode: return this->visit_WhileNode(static_cast<WhileNode*>(node), context);
        default: {
...
RuntimeResult Interpreter::visit_BinaryOperationNode(BinaryOperationNode *node, Context& context) {
    ...
    if(right_o->type != ObjectType::Number && right_o->type != ObjectType::Boolean && right_o->type != ObjectType::String)
        return *result.failure(IllegalOperationError(
                *node->start_pos, *node->end_pos,
                "Expected number, boolean, or string"
        ));
